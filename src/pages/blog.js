...
const Blog = () => {
    ...
    return(
        <Layout>
            <SEO title="Blog" image="computer.jpg" description="A blog written by Diego De La Torre. I write mostly about technology, and the problems I face and the things I like to build along the way."></SEO>
